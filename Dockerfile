...
COPY vendor/artifacts/cloudcli-ai-cloudcli-1.33.1.tgz /tmp/vendor/cloudcli-ai-cloudcli-1.33.1.tgz

# ---------- CloudCLI (web UI for Claude Code) ----------
RUN npm i -g /tmp/vendor/cloudcli-ai-cloudcli-1.33.1.tgz && rm -f /tmp/vendor/cloudcli-ai-cloudcli-1.33.1.tgz
