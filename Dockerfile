...
COPY vendor/artifacts/cloudcli-ai-cloudcli-1.32.0.tgz /tmp/vendor/cloudcli-ai-cloudcli-1.32.0.tgz

# ---------- CloudCLI (web UI for Claude Code) ----------
RUN npm i -g /tmp/vendor/cloudcli-ai-cloudcli-1.32.0.tgz && rm -f /tmp/vendor/cloudcli-ai-cloudcli-1.32.0.tgz
